    ...
    <>
       ...
       <section id="part1" className="text-white text-center video-blog ">
        <div className="container container__video">
          ...
          <div className='container container__video'>
          <iframe width="100%" height="580" src="https://rutube.ru/video/f1e2bd72fcb35fe0c3651e147274d7df/?r=wd" frameBorder="0" allow="clipboard-write; autoplay" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
         </div>      
          </div>
        </div>
      </section>
