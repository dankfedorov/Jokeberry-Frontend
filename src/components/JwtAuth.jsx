        ...
        <div className=" container__jwtauth">
          ...
          <div className="row ">
            <div className="col-md-12">
              ...
              <p className="p-2 "> <b>Пример токена:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9W67F264ysBcMcBndcEAs6g"</b>
              </p>
            ...
            <div className="col-md-12">
              ...
              <p className="p-2">JWT (JSON Web Token) авторизация работает следующим образом: </p>
              <p className="p-2">При входе пользователя в систему сервер проверяет его учетные данные.</p>
              <p className="p-2">Если они корректны, сервер создает JWT токен, который содержит закодированную информацию о пользователе и его правах доступа.</p>
              <p className="p-2">Токен отправляется клиенту, который сохраняет его (например, в локальном хранилище).</p>
            </div>
          </div>
        </div>
      </section>
