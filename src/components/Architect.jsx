      ...
      <div className=" container__architect">
        ...
        <div className="row ">
          <div className="col-md-6">
            <p className="p-2">
              Архитектура сайта – это своеобразный «каркас», на котором строится интернет-ресурс. 
            ...
            <p className="p-2">
              Чтобы понять, как работает сайт, представьте себе ресторан. 
              В этом сравнении фронтэнд – это «лицо» заведения: как оно выглядит, 
              как оформлено меню и сколько усилий приложения затрачивают на обслуживание клиентов. 
              Это то, что видит и с чем взаимодействует пользователь. Фронтэнд включает в себя все 
              визуальные элементы: графику, текст, кнопки и элементы навигации. 
              Работают с фронтэндом в основном веб-дизайнеры и фронтэнд-разработчики, 
              используя языки программирования, такие как HTML, CSS и JavaScript.
            </p>
            <p className="p-2">
              Бэкэнд, в свою очередь, можно представить как кухню ресторана. 
              Именно здесь происходит «магия», когда заказ превращается в блюдо. 
              Бэкэнд отвечает за обработку данных, управление пользователями и хранение информации. 
              Это то, что происходит за кулисами, и обычно это невидимо для посетителей сайта.
               Бэкэнд-разработчики используют серверные языки программирования (такие как Python, Ruby, PHP)
                и базы данных для обеспечения работы сайта.
            </p>
          </div>
          ...
          <div className="col-md-6">
            ...
            <p className="p-2">
              Когда пользователь заходит на сайт, его запрос отправляется на бэкэнд, 
              где он обрабатывается. После этого бэкэнд собирает необходимые данные и 
              отправляет их обратно во фронтэнд, который отображает результат на экране 
              пользователя. Благодаря этой синергии фронтэнда и бэкэнда сайт становится динамичным и интерактивным.
            </p>
            <p className="p-2">
              ...
              и эффективный опыт использования. Правильная архитектура сайта и гармоничное
