          ...
          <div className="row d-flex align-items-center justify-content-between">
            <div className="col-md-8">
              <span className="p-1">
                ...
                <p className="mb-2">
                  Проект нацелен на обеспечение максимальной
                  производительности, безопасности и масштабируемости, что
                ...
                <p>
                  ...
                  обеспечиваться с помощью языков программирования, таких как
