    ...
    <div>
      ...
      <div className=" container__introinfo">
        ...
        <div className="row ">
          ...
          <p className="p-2"><b>Привет! Спасибо, что заглянули на мой проект по созданию сайта на React. Я рад поделиться с вами своими наработками и демонстрировать, как можно строить интерактивные пользовательские интерфейсы с помощью этой библиотеки.</b></p>
          ...
          <p className="p-2">Мы реализовали JWT авторизацию для безопасного доступа пользователей к приложению, а также наладили взаимодействие с базой данных и серверной частью, построенной на Node.js + Express библиотека. </p>
