        ...
        <div className="container">
          <div className="row p-2">
            ...
            <div className="col-md-6 ">
              ...
              <p className=" mb-4">
                Для перехода пользователю достаточно навести камеру на QR-код
                или использовать специализированное приложение. Это отличный
                способ увеличить трафик на сайте, особенно на мероприятиях, в
                маркетинговых материалах или на упаковке продуктов.
              </p>
              <p className=" mb-4">
